...
async function fetchCaseDetailsManualCaptcha({ courtIndex, caseIndex, caseNumber, caseYear }) {
  ...
  console.log("Please switch to the browser and fill in the CAPTCHA manually.");
  await askQuestion("Press Enter in this console once you have filled in the CAPTCHA...");
